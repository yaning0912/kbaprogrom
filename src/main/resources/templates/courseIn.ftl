...
<html>
  <head>
    <title>KAB课程介绍管理</title>
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
    <meta name="apple-mobile-web-app-capable" content="yes"/>
    <link href="resources/css/jquery-ui-themes.css" type="text/css" rel="stylesheet"/>
    <link href="resources/css/axure_rp_page.css" type="text/css" rel="stylesheet"/>
    <link href="data/styles.css" type="text/css" rel="stylesheet"/>
    <link href="files/kab课程介绍管理/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/kab课程介绍管理/data.js"></script>
  ...
  <body>
    ...
    <div id="u0" class="ax_图片">
      <img id="u0_img" class="img " src="images/修改密码_1/u0.jpg"/>
      <!-- Unnamed () -->
    ...
    <!-- Unnamed (表格) -->
    <div id="u10" class="ax_表格">

      <!-- Unnamed (表格单元) -->
      <div id="u11" class="ax_表格单元">
        <img id="u11_img" class="img " src="images/新闻管理/u27.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u13" class="ax_表格单元">
        <img id="u13_img" class="img " src="images/新闻管理/u29.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u15" class="ax_表格单元">
        <img id="u15_img" class="img " src="images/新闻管理/u31.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u17" class="ax_表格单元">
        <img id="u17_img" class="img " src="images/新闻管理/u33.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u19" class="ax_表格单元">
        <img id="u19_img" class="img " src="images/新闻管理/u35.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u21" class="ax_表格单元">
        <img id="u21_img" class="img " src="images/新闻管理/u37.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u23" class="ax_表格单元">
        <img id="u23_img" class="img " src="images/新闻管理/u39.png"/>
        <!-- Unnamed () -->
        <div id="u24" class="text">
          <p><span>新商业合伙人峰会举行</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u25" class="ax_表格单元">
        <img id="u25_img" class="img " src="images/新闻管理/u41.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u27" class="ax_表格单元">
        <img id="u27_img" class="img " src="images/新闻管理/u43.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u29" class="ax_表格单元">
        <img id="u29_img" class="img " src="images/新闻管理/u45.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u31" class="ax_表格单元">
        <img id="u31_img" class="img " src="images/新闻管理/u47.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u33" class="ax_表格单元">
        <img id="u33_img" class="img " src="images/新闻管理/u49.png"/>
        <!-- Unnamed () -->
        <div id="u34" class="text">
          <p><span>温州：底线思维防范企业.</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u35" class="ax_表格单元">
        <img id="u35_img" class="img " src="images/新闻管理/u51.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u37" class="ax_表格单元">
        <img id="u37_img" class="img " src="images/新闻管理/u53.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u39" class="ax_表格单元">
        <img id="u39_img" class="img " src="images/新闻管理/u55.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u41" class="ax_表格单元">
        <img id="u41_img" class="img " src="images/新闻管理/u37.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u43" class="ax_表格单元">
        <img id="u43_img" class="img " src="images/新闻管理/u39.png"/>
        <!-- Unnamed () -->
        <div id="u44" class="text">
          <p><span>企业登记拿证快&nbsp; </span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u45" class="ax_表格单元">
        <img id="u45_img" class="img " src="images/新闻管理/u41.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u47" class="ax_表格单元">
        <img id="u47_img" class="img " src="images/新闻管理/u43.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u49" class="ax_表格单元">
        <img id="u49_img" class="img " src="images/新闻管理/u45.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u51" class="ax_表格单元">
        <img id="u51_img" class="img " src="images/新闻管理/u67.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u53" class="ax_表格单元">
        <img id="u53_img" class="img " src="images/新闻管理/u69.png"/>
        <!-- Unnamed () -->
        <div id="u54" class="text">
          <p><span>创新助中小微企业成为科..</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u55" class="ax_表格单元">
        <img id="u55_img" class="img " src="images/新闻管理/u71.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u57" class="ax_表格单元">
        <img id="u57_img" class="img " src="images/新闻管理/u73.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u59" class="ax_表格单元">
        <img id="u59_img" class="img " src="images/新闻管理/u75.png"/>
        <!-- Unnamed () -->
    ...
    <div id="u79" class="ax_形状">
      <img id="u79_img" class="img " src="images/kab公告/u99.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u83" class="ax_图片">
      <img id="u83_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u85" class="ax_图片">
      <img id="u85_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <!-- Unnamed (复选框) -->
    <div id="u91" class="ax_复选框">
      <label for="u91_input">
        <!-- Unnamed () -->
        <div id="u92" class="text"></div>
      </label>
      <input id="u91_input" type="checkbox" value="checkbox" checked/>
    </div>

    <!-- Unnamed (复选框) -->
    <div id="u93" class="ax_复选框">
      <label for="u93_input">
        <!-- Unnamed () -->
    ...
    <div id="u95" class="ax_形状">
      <img id="u95_img" class="img " src="images/kab课程介绍管理/u95.png"/>
      <!-- Unnamed () -->
      <div id="u96" class="text">
        <p><span>+ </span><span>添加</span><span>KAB课程介绍</span></p>
      </div>
    </div>

    <!-- confirm (动态面板) -->
    <div id="u97" class="ax_动态面板" data-label="confirm">
      <div id="u97_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u98" class="ax_形状">
          <img id="u98_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u102" class="ax_水平线">
          ...
          <img id="u102_line" class="img " src="images/修改密码_1/u48_line.png" alt="u102_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u103" class="ax_形状">
          <img id="u103_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u105" class="ax_图片">
          <img id="u105_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u107" class="ax_文本">
          ...
          <div id="u108" class="text">
            <p><span>确定删除该</span><span>课程介绍</span><span>吗？</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u109" class="ax_图片">
          <img id="u109_img" class="img " src="images/新闻管理/u158.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u111" class="ax_形状">
          <img id="u111_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u115" class="ax_图片">
      <img id="u115_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u117" class="ax_图片">
      <img id="u117_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u119" class="ax_图片">
      <img id="u119_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u125" class="ax_图片">
      <img id="u125_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u131" class="ax_文本">
      ...
      <div id="u132" class="text">
        <p><span>·</span><span>宣传</span><span>管理 </span><span>&nbsp; </span><span>》</span></p>
      </div>
    </div>
    ...
    <div id="u135" class="ax_水平线">
      ...
      <img id="u135_line" class="img " src="images/修改密码_1/u24_line.png" alt="u135_line"/>
    </div>

    <!-- 导航 (动态面板) -->
    <div id="u136" class="ax_动态面板" data-label="导航">
      <div id="u136_state0" class="panel_state" data-label="State1">
        ...
        <div id="u147" class="ax_水平线">
          ...
          <img id="u147_line" class="img " src="images/修改密码_1/u21_line.png" alt="u147_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u148" class="ax_形状">
          <img id="u148_img" class="img " src="images/新闻管理/u12.png"/>
          <!-- Unnamed () -->
