...
<html>
  <head>
    ...
    <link href="files/修改密码_1/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/修改密码_1/data.js"></script>
  ...
  <body>
    ...
    <!-- 导航 (动态面板) -->
    <div id="u10" class="ax_动态面板" data-label="导航">
      <div id="u10_state0" class="panel_state" data-label="State1">
        ...
        <div id="u21" class="ax_水平线">
          ...
          <img id="u21_line" class="img " src="images/修改密码_1/u21_line.png" alt="u21_line"/>
        </div>
    ...
    <div id="u24" class="ax_水平线">
      ...
      <img id="u24_line" class="img " src="images/修改密码_1/u24_line.png" alt="u24_line"/>
    </div>
    ...
    <div id="u27" class="ax_图片">
      <img id="u27_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u37" class="ax_文本框_单行_">
      <input id="u37_input" type="password" value=""/>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u38" class="ax_文本框_单行_">
      <input id="u38_input" type="password" value=""/>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u39" class="ax_文本框_单行_">
      <input id="u39_input" type="password" value=""/>
    </div>
    ...
    <!-- alert (动态面板) -->
    <div id="u43" class="ax_动态面板" data-label="alert">
      <div id="u43_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u44" class="ax_形状">
          <img id="u44_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u48" class="ax_水平线">
          ...
          <img id="u48_line" class="img " src="images/修改密码_1/u48_line.png" alt="u48_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u49" class="ax_形状">
          <img id="u49_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u51" class="ax_图片">
          <img id="u51_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u55" class="ax_图片">
          <img id="u55_img" class="img " src="images/修改密码_1/u55.png"/>
          <!-- Unnamed () -->
