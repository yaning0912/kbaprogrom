...
<html>
  <head>
    ...
    <link href="files/修改新闻/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/修改新闻/data.js"></script>
  ...
  <body>
    ...
    <div id="u34" class="ax_水平线">
      ...
      <img id="u34_line" class="img " src="images/修改密码_1/u24_line.png" alt="u34_line"/>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u35" class="ax_文本框_单行_">
      <input id="u35_input" type="text" value=" 第三届”青年恒好“ 成果发布会在京举行"/>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u36" class="ax_文本框_多行_">
      <textarea id="u36_input">&nbsp;&nbsp; 四川美术学院的姚蓓蓓多次参加“青年恒好”活动，并屡次得奖。今年11月27日，由姚蓓蓓负责的织梦编织吧终于在四川美术学院落地，这让她非常兴奋。“织毛衣、织围巾已经不像我小时候那么热门，可实际上古老的编织技艺是创作艺术品的手段，通过编织成画等艺术加工，就能够将几十元的毛线变成价值上千元、上万元的艺术品。”她告诉记者，“这正是国际上流行的‘纤维艺术’，我希望能把纤维艺术带入中国。”
 
&nbsp; &nbsp; 像姚蓓蓓一样，通过“青年恒好”活动实现创业梦想的大学生越来越多。12月18日，由KAB全国推广办公室、恒源祥（集团）有限公司主办的第三届“青年恒好”成果发布会在北京召开。本届活动以“中国梦”为主题，除了对公益创业项目、校园编织吧创业计划书进行征集，还对大学生创意编织进行展示，同时资助公益创业项目及校园编织吧，引导大学生树立公益创业意识，扶持资助大学生创业实践活动。</textarea>
    </div>
    ...
    <div id="u41" class="ax_图片">
      <img id="u41_img" class="img " src="images/添加新闻/u41.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u45" class="ax_文本框_单行_">
      <input id="u45_input" type="text" value="admin"/>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u46" class="ax_文本框_单行_">
      <input id="u46_input" type="text" value="0"/>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u47" class="ax_形状">
      <img id="u47_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u49" class="ax_形状">
      <img id="u49_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <!-- alert (动态面板) -->
    <div id="u51" class="ax_动态面板" data-label="alert">
      <div id="u51_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u52" class="ax_形状">
          <img id="u52_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u56" class="ax_水平线">
          ...
          <img id="u56_line" class="img " src="images/修改密码_1/u48_line.png" alt="u56_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u57" class="ax_形状">
          <img id="u57_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u59" class="ax_图片">
          <img id="u59_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u63" class="ax_图片">
          <img id="u63_img" class="img " src="images/修改密码_1/u55.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u67" class="ax_单选框">
      ...
      <input id="u67_input" type="radio" value="radio" data-label="1" name="u67" checked/>
    </div>
    ...
    <div id="u69" class="ax_单选框">
      ...
      <input id="u69_input" type="radio" value="radio" data-label="2" name="u69"/>
    </div>
  </body>
</html>
