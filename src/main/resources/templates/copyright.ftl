...
<html>
  <head>
    ...
    <link href="files/版权声明/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/版权声明/data.js"></script>
  ...
  <body>
    ...
    <div id="u64" class="ax_文本">
      ...
      <div id="u65" class="text">
        <p><span>本网站的所有内容，包括但不限于文字，图标，商标，标识，按钮，图像，声音片段，数据以及软件等，当网站注册用户在论坛，博客，微波以及其他应用下载粘贴，商城发布的其他形式之知识产权，均与我们相关权方单独或共同享有。并受著作权和其他相关法律 法规的保护，未经我们或相关部门的准许，不能转载，使用，复制，发行本哇工作的内容。</span></p>
      </div>
    </div>
