...
<html>
  <head>
    ...
    <link href="files/评论管理/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/评论管理/data.js"></script>
  ...
  <body>
    ...
    <div id="u32" class="ax_水平线">
      ...
      <img id="u32_line" class="img " src="images/修改密码_1/u24_line.png" alt="u32_line"/>
    </div>

    <!-- Unnamed (表格) -->
    <div id="u33" class="ax_表格">

      <!-- Unnamed (表格单元) -->
      <div id="u34" class="ax_表格单元">
        <img id="u34_img" class="img " src="images/评论管理/u34.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (表格单元) -->
      <div id="u36" class="ax_表格单元">
        <img id="u36_img" class="img " src="images/评论管理/u36.png"/>
        <!-- Unnamed () -->
        <div id="u37" class="text">
          <p><span>评论</span><span>内容</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u38" class="ax_表格单元">
        <img id="u38_img" class="img " src="images/评论管理/u38.png"/>
        <!-- Unnamed () -->
        <div id="u39" class="text">
          <p><span>评论</span><span>日期</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u40" class="ax_表格单元">
        <img id="u40_img" class="img " src="images/评论管理/u40.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (表格单元) -->
      <div id="u42" class="ax_表格单元">
        <img id="u42_img" class="img " src="images/评论管理/u42.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (表格单元) -->
      <div id="u44" class="ax_表格单元">
        <img id="u44_img" class="img " src="images/评论管理/u44.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (表格单元) -->
      <div id="u46" class="ax_表格单元">
        <img id="u46_img" class="img " src="images/评论管理/u46.png"/>
        <!-- Unnamed () -->
      ...
      <!-- Unnamed (表格单元) -->
      <div id="u48" class="ax_表格单元">
        <img id="u48_img" class="img " src="images/评论管理/u48.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u50" class="ax_表格单元">
        <img id="u50_img" class="img " src="images/评论管理/u50.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u52" class="ax_表格单元">
        <img id="u52_img" class="img " src="images/评论管理/u52.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u54" class="ax_表格单元">
        <img id="u54_img" class="img " src="images/评论管理/u54.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u56" class="ax_表格单元">
        <img id="u56_img" class="img " src="images/评论管理/u56.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u58" class="ax_表格单元">
        <img id="u58_img" class="img " src="images/评论管理/u42.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u60" class="ax_表格单元">
        <img id="u60_img" class="img " src="images/评论管理/u44.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u62" class="ax_表格单元">
        <img id="u62_img" class="img " src="images/评论管理/u46.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u64" class="ax_表格单元">
        <img id="u64_img" class="img " src="images/评论管理/u48.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u66" class="ax_表格单元">
        <img id="u66_img" class="img " src="images/评论管理/u66.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u68" class="ax_表格单元">
        <img id="u68_img" class="img " src="images/评论管理/u68.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u70" class="ax_表格单元">
        <img id="u70_img" class="img " src="images/评论管理/u70.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u72" class="ax_表格单元">
        <img id="u72_img" class="img " src="images/评论管理/u72.png"/>
        <!-- Unnamed () -->
    ...
    <div id="u74" class="ax_图片">
      <img id="u74_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
      <div id="u75" class="text"></div>
    </div>

    <!-- confirm (动态面板) -->
    <div id="u76" class="ax_动态面板" data-label="confirm">
      <div id="u76_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u77" class="ax_形状">
          <img id="u77_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u81" class="ax_水平线">
          ...
          <img id="u81_line" class="img " src="images/修改密码_1/u48_line.png" alt="u81_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u82" class="ax_形状">
          <img id="u82_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u84" class="ax_图片">
          <img id="u84_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u86" class="ax_文本">
          ...
          <div id="u87" class="text">
            <p><span>确定删除该</span><span>评论</span><span>吗？</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u88" class="ax_图片">
          <img id="u88_img" class="img " src="images/新闻管理/u158.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u90" class="ax_形状">
          <img id="u90_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u92" class="ax_图片">
      <img id="u92_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u94" class="ax_图片">
      <img id="u94_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u96" class="ax_图片">
      <img id="u96_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u116" class="ax_形状">
      <img id="u116_img" class="img " src="images/kab公告/u99.png"/>
      <!-- Unnamed () -->
    ...
    <!-- alert (动态面板) -->
    <div id="u120" class="ax_动态面板" data-label="alert">
      <div id="u120_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u121" class="ax_形状">
          <img id="u121_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u125" class="ax_水平线">
          ...
          <img id="u125_line" class="img " src="images/修改密码_1/u48_line.png" alt="u125_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u126" class="ax_形状">
          <img id="u126_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u128" class="ax_图片">
          <img id="u128_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u132" class="ax_图片">
          <img id="u132_img" class="img " src="images/修改密码_1/u55.png"/>
          <!-- Unnamed () -->
