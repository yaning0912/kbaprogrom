...
<html>
  ...
  <body>
    ...
    <div id="u11" class="ax_图片">
      <img id="u11_img" class="img " src="images/首页/u19.png"/>
      <!-- Unnamed () -->
    ...
    <!-- fin (动态面板) -->
    <div id="u17" class="ax_动态面板" data-label="fin">
      <div id="u17_state0" class="panel_state" data-label="step1">
        ...
        <div id="u21" class="ax_形状">
          <img id="u21_img" class="img " src="images/找回密码/u21.png"/>
          <!-- Unnamed () -->
      ...
      <div id="u17_state1" class="panel_state" data-label="step2">
        ...
        <div id="u26" class="ax_形状">
          <img id="u26_img" class="img " src="images/找回密码/u26.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u30" class="ax_文本">
          ...
          <div id="u31" class="text">
            <p><span>我的小学班主任姓名？</span></p>
          </div>
        </div>

        <!-- alert-添加成功 (动态面板) -->
        <div id="u32" class="ax_动态面板" data-label="alert-添加成功">
          <div id="u32_state0" class="panel_state" data-label="State1">

            <!-- border (形状) -->
            <div id="u33" class="ax_形状" data-label="border">
              <img id="u33_img" class="img " src="images/修改个人资料/border_u253.png"/>
              <!-- Unnamed () -->
            ...
            <div id="u35" class="ax_图片">
              <img id="u35_img" class="img " src="images/修改个人资料/u255.jpg"/>
              <!-- Unnamed () -->
            ...
            <div id="u37" class="ax_图片">
              <img id="u37_img" class="img " src="images/修改个人资料/u257.jpg"/>
              <!-- Unnamed () -->
            ...
            <div id="u39" class="ax_文本">
              ...
              <div id="u40" class="text">
                <p><span>回答正确！</span></p><p><span>密码已发注册邮箱，请及时查收。</span></p>
              </div>
            </div>
            ...
            <div id="u43" class="ax_形状">
              <img id="u43_img" class="img " src="images/修改个人资料/u263.png"/>
              <!-- Unnamed () -->
      ...
      <div id="u17_state2" class="panel_state" data-label="step3">
        ...
        <div id="u47" class="ax_文本框_单行_">
          <input id="u47_input" type="password" value=""/>
        </div>
        ...
        <div id="u48" class="ax_文本">
          ...
          <div id="u49" class="text">
            <p><span>再次</span><span>输入新密码：</span></p>
          </div>
        </div>

        <!-- Unnamed (文本框(单行)) -->
        <div id="u50" class="ax_文本框_单行_">
          <input id="u50_input" type="password" value=""/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u51" class="ax_形状">
          <img id="u51_img" class="img " src="images/找回密码/u21.png"/>
          <!-- Unnamed () -->
        ...
        <!-- alert-添加成功 (动态面板) -->
        <div id="u53" class="ax_动态面板" data-label="alert-添加成功">
          <div id="u53_state0" class="panel_state" data-label="State1">

            <!-- border (形状) -->
            <div id="u54" class="ax_形状" data-label="border">
              <img id="u54_img" class="img " src="images/修改个人资料/border_u253.png"/>
              <!-- Unnamed () -->
            ...
            <div id="u56" class="ax_图片">
              <img id="u56_img" class="img " src="images/修改个人资料/u255.jpg"/>
              <!-- Unnamed () -->
            ...
            <div id="u58" class="ax_图片">
              <img id="u58_img" class="img " src="images/修改个人资料/u257.jpg"/>
              <!-- Unnamed () -->
            ...
            <div id="u64" class="ax_形状">
              <img id="u64_img" class="img " src="images/修改个人资料/u263.png"/>
              <!-- Unnamed () -->
        ...
        <div id="u66" class="ax_文本">
          ...
          <div id="u67" class="text">
            <p><span>注：此页面由点击修改密码时发送的邮件中链接地址打开</span></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="u69" class="ax_水平线">
      ...
      <img id="u69_line" class="img " src="images/首页/u228_line.png" alt="u69_line"/>
    </div>
