...
<html>
  <head>
    ...
    <link href="files/修改kab公告/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/修改kab公告/data.js"></script>
  ...
  <body>
    ...
    <div id="u15" class="ax_文本框_单行_">
      <input id="u15_input" type="text" value="关于申报2013年度“大学生KAB 创业教育基地”和“KAB创业教育讲师资格”的通知"/>
    </div>

    <!-- Unnamed (文本框(多行)) -->
    <div id="u16" class="ax_文本框_多行_">
      <textarea id="u16_input">
有关KAB项目高校：
...
&nbsp; &nbsp; 2．将《大学生KAB创业基础》课程纳入学校公共选修课体系，每学期授课时
 </textarea>
    </div>
    ...
    <div id="u19" class="ax_图片">
      <img id="u19_img" class="img " src="images/添加新闻/u41.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u23" class="ax_文本框_单行_">
      <input id="u23_input" type="text" value="admin"/>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u24" class="ax_形状">
      <img id="u24_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <!-- alert (动态面板) -->
    <div id="u28" class="ax_动态面板" data-label="alert">
      <div id="u28_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u29" class="ax_形状">
          <img id="u29_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u33" class="ax_水平线">
          ...
          <img id="u33_line" class="img " src="images/修改密码_1/u48_line.png" alt="u33_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u34" class="ax_形状">
          <img id="u34_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u36" class="ax_图片">
          <img id="u36_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u40" class="ax_图片">
          <img id="u40_img" class="img " src="images/修改密码_1/u55.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u42" class="ax_文本">
      ...
      <div id="u43" class="text">
        <p><span>KAB</span><span>公告管理</span></p>
      </div>
    </div>
    ...
    <div id="u44" class="ax_文本">
      ...
      <div id="u45" class="text">
        <p><span>》 </span><span>修改KAB公告</span></p>
      </div>
    </div>

    <!-- 导航 (动态面板) -->
    <div id="u46" class="ax_动态面板" data-label="导航">
      <div id="u46_state0" class="panel_state" data-label="State1">
        ...
        <div id="u57" class="ax_水平线">
          ...
          <img id="u57_line" class="img " src="images/修改密码_1/u21_line.png" alt="u57_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u58" class="ax_形状">
          <img id="u58_img" class="img " src="images/新闻管理/u12.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u62" class="ax_下拉列表框">
      <select id="u62_input">
        ...
        <option selected value="紧急">紧急</option>
