...
<html>
  <head>
    ...
    <link href="files/添加课程介绍/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/添加课程介绍/data.js"></script>
  ...
  <body>
    ...
    <div id="u25" class="ax_文本框_单行_">
      <input id="u25_input" type="text" value="admin"/>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u26" class="ax_形状">
      <img id="u26_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u28" class="ax_形状">
      <img id="u28_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <!-- alert (动态面板) -->
    <div id="u30" class="ax_动态面板" data-label="alert">
      <div id="u30_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u31" class="ax_形状">
          <img id="u31_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u35" class="ax_水平线">
          ...
          <img id="u35_line" class="img " src="images/修改密码_1/u48_line.png" alt="u35_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u36" class="ax_形状">
          <img id="u36_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u38" class="ax_图片">
          <img id="u38_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u42" class="ax_图片">
          <img id="u42_img" class="img " src="images/修改密码_1/u55.png"/>
          <!-- Unnamed () -->
    ...
    <!-- 导航 (动态面板) -->
    <div id="u48" class="ax_动态面板" data-label="导航">
      <div id="u48_state0" class="panel_state" data-label="State1">
        ...
        <div id="u59" class="ax_水平线">
          ...
          <img id="u59_line" class="img " src="images/修改密码_1/u21_line.png" alt="u59_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u60" class="ax_形状">
          <img id="u60_img" class="img " src="images/新闻管理/u12.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u70" class="ax_文本">
      ...
      <div id="u71" class="text">
        <p><span>》 添加</span><span>KAB</span><span>课程介绍</span></p>
      </div>
    </div>

    <!-- 1 (单选框) -->
    <div id="u72" class="ax_单选框">
      <label for="u72_input">
        <!-- Unnamed () -->
      ...
      <input id="u72_input" type="radio" value="radio" data-label="1" name="u72" checked/>
    </div>

    <!-- 2 (单选框) -->
    <div id="u74" class="ax_单选框">
      <label for="u74_input">
        <!-- Unnamed () -->
      ...
      <input id="u74_input" type="radio" value="radio" data-label="2" name="u74"/>
    </div>
  </body>
</html>
