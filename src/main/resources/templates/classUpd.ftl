...
<html>
  <head>
    ...
    <link href="files/修改班级/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/修改班级/data.js"></script>
  ...
  <body>
    ...
    <!-- 主导航 (动态面板) -->
    <div id="u36" class="ax_动态面板" data-label="主导航">
      <div id="u36_state0" class="panel_state" data-label="State1">
        ...
        <div id="u49" class="ax_水平线">
          ...
          <img id="u49_line" class="img " src="images/首页/u224_line.png" alt="u49_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u50" class="ax_形状">
          <img id="u50_img" class="img " src="images/首页/u225.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u52" class="ax_文本">
      ...
      <div id="u53" class="text">
        <p><span>班级名称</span><span>：</span></p>
      </div>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u54" class="ax_文本框_单行_">
      <input id="u54_input" type="text" value="创业实训班"/>
    </div>
    ...
    <div id="u55" class="ax_文本">
      ...
      <div id="u56" class="text">
        <p><span>班级类型</span><span>：</span></p>
      </div>
    </div>

    <!-- Unnamed (下拉列表框) -->
    <div id="u57" class="ax_下拉列表框">
      <select id="u57_input">
    ...
    <div id="u58" class="ax_文本">
      ...
      <div id="u59" class="text">
        <p><span>班级</span><span>状态</span><span>：</span></p>
      </div>
    </div>

    <!-- Unnamed (下拉列表框) -->
    <div id="u60" class="ax_下拉列表框">
      <select id="u60_input">
        <option value="--请选择--">--请选择--</option>
        <option value="开班前">开班前</option>
        <option selected value="开班中">开班中</option>
        <option value="班级关闭">班级关闭</option>
      </select>
    </div>

    <!-- createSchool (动态面板) -->
    <div id="u61" class="ax_动态面板" data-label="createSchool">
      <div id="u61_state0" class="panel_state" data-label="1">
        ...
        <div id="u62" class="ax_文本">
          ...
          <div id="u63" class="text">
            <p><span>没有我要的学校，</span></p>
          </div>
        </div>

        <!-- 马上去创建 (形状) -->
        <div id="u64" class="ax_文本" data-label="马上去创建">
          <img id="u64_img" class="img " src="resources/images/transparent.gif"/>
          <!-- Unnamed () -->
          <div id="u65" class="text">
            <p><span>马上创建</span><span>？</span></p>
          </div>
        </div>
        ...
        <div id="u70" class="ax_文本">
          ...
          <div id="u71" class="text">
            <p><span>(</span><span>注：</span><span>这里是联动菜单)</span></p>
          </div>
        </div>
      </div>
      <div id="u61_state1" class="panel_state" data-label="2">
        ...
        <div id="u75" class="ax_文本">
          ...
          <div id="u76" class="text">
            <p><span>选择所在</span><span>省份</span><span>：</span></p>
          </div>
        </div>

        <!-- 添加 (形状) -->
        <div id="u77" class="ax_文本" data-label="添加">
        ...
        <div id="u79" class="ax_文本">
          ...
          <div id="u80" class="text">
            <p><span>返回</span><span>选择学校</span></p>
          </div>
        </div>
        ...
        <!-- 添加成功 (形状) -->
        <div id="u82" class="ax_文本" data-label="添加成功">
          <img id="u82_img" class="img " src="resources/images/transparent.gif"/>
          <!-- Unnamed () -->
          <div id="u83" class="text">
            <p><span>添加</span><span>成功！</span></p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="u84" class="ax_形状">
      <img id="u84_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u90" class="ax_文本">
      ...
      <div id="u91" class="text">
        <p><span>（默认系统自动带出）</span></p>
      </div>
    </div>

    <!-- alert (动态面板) -->
    <div id="u92" class="ax_动态面板" data-label="alert">
      <div id="u92_state0" class="panel_state" data-label="State1">

        <!-- border (形状) -->
        <div id="u93" class="ax_形状" data-label="border">
          <img id="u93_img" class="img " src="images/修改个人资料/border_u253.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u95" class="ax_图片">
          <img id="u95_img" class="img " src="images/修改个人资料/u255.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u97" class="ax_图片">
          <img id="u97_img" class="img " src="images/修改个人资料/u257.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u99" class="ax_文本">
          ...
          <div id="u100" class="text">
            <p><span>班级</span><span>修改</span><span>成功</span></p>
          </div>
        </div>
        ...
        <div id="u103" class="ax_形状">
          <img id="u103_img" class="img " src="images/修改个人资料/u263.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u111" class="ax_图片">
      <img id="u111_img" class="img " src="images/管理班级/u42.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u126" class="ax_水平线">
      ...
      <img id="u126_line" class="img " src="images/首页/u228_line.png" alt="u126_line"/>
    </div>
