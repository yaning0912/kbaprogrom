...
<html>
  <head>
    ...
    <link href="files/kab公告/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/kab公告/data.js"></script>
  ...
  <body>
    ...
    <div id="u28" class="ax_水平线">
      ...
      <img id="u28_line" class="img " src="images/kab公告/u28_line.png" alt="u28_line"/>
    </div>
