...
<html>
  ...
  <body>
    ...
    <div id="u20" class="ax_文本框_单行_">
      <input id="u20_input" type="password" value=""/>
    </div>
    ...
    <div id="u24" class="ax_图片">
      <img id="u24_img" class="img " src="images/首页/u32.jpg"/>
      <!-- Unnamed () -->
    ...
    <div id="u30" class="ax_文本">
      ...
      <div id="u31" class="text">
        <p><span>没有账户,马上去注册</span></p>
      </div>
    </div>

    <!-- Unnamed (形状) -->
    <div id="u32" class="ax_形状">
      <img id="u32_img" class="img " src="images/会员登录/u32.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u34" class="ax_图片">
      <img id="u34_img" class="img " src="images/会员登录/u34.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u39" class="ax_水平线">
      ...
      <img id="u39_line" class="img " src="images/首页/u228_line.png" alt="u39_line"/>
    </div>
