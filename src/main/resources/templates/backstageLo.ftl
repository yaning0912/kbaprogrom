...
<html>
  <head>
    ...
    <link href="files/后台登录/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/后台登录/data.js"></script>
  ...
  <body>
    ...
    <div id="u0" class="ax_形状">
      <img id="u0_img" class="img " src="images/后台登录/u0.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u2" class="ax_水平线">
      ...
      <img id="u2_line" class="img " src="images/首页/u10_line.png" alt="u2_line"/>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u3" class="ax_图片">
      <img id="u3_img" class="img " src="images/首页/u11.jpg"/>
      <!-- Unnamed () -->
    ...
    <!-- Unnamed (文本框(单行)) -->
    <div id="u10" class="ax_文本框_单行_">
      <input id="u10_input" type="password" value=""/>
    </div>
    ...
    <div id="u11" class="ax_水平线">
      ...
      <img id="u11_line" class="img " src="images/首页/u228_line.png" alt="u11_line"/>
    </div>
    ...
    <div id="u16" class="ax_形状">
      <img id="u16_img" class="img " src="images/后台登录/u16.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u18" class="ax_文本">
      ...
      <div id="u19" class="text">
        <p><span>KAB</span><span>创业</span><span>教育网</span><span>--管理员登录</span></p>
      </div>
    </div>
  </body>
</html>
