...
<html>
  <head>
    ...
    <link href="files/kab课程/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/kab课程/data.js"></script>
  ...
  <body>
    ...
    <div id="u86" class="ax_水平线">
      ...
      <img id="u86_line" class="img " src="images/首页/u228_line.png" alt="u86_line"/>
    </div>
