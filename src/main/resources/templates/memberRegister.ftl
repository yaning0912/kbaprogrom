  ...
  <body>
    ...
    <div id="u0" class="ax_文本">
      ...
      <div id="u1" class="text">
        <p><span>欢迎登陆</span><span>&nbsp;</span><span>KAB创业教育网&nbsp; </span></p>
      </div>
    </div>
    ...
    <div id="u18" class="ax_文本框_单行_">
      <input id="u18_input" type="password" value=""/>
    </div>
    ...
    <div id="u22" class="ax_图片">
      <img id="u22_img" class="img " src="images/首页/u32.jpg"/>
      <!-- Unnamed () -->
    ...
    <div id="u26" class="ax_形状">
      <img id="u26_img" class="img " src="images/会员注册/u26.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u28" class="ax_文本">
      ...
      <div id="u29" class="text">
        <p><span>确认</span><span>密</span><span>码</span></p>
      </div>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u30" class="ax_文本框_单行_">
      <input id="u30_input" type="password" value=""/>
    </div>
    ...
    <div id="u33" class="ax_文本">
      ...
      <div id="u34" class="text">
        <p><span style="color:#5E5E5E;">已经有账号了，</span><span style="color:#339900;">立即登录</span></p>
      </div>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u35" class="ax_图片">
      <img id="u35_img" class="img " src="images/会员注册/u35.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u39" class="ax_图片">
      <img id="u39_img" class="img " src="images/会员注册/u39.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u55" class="ax_水平线">
      ...
      <img id="u55_line" class="img " src="images/首页/u228_line.png" alt="u55_line"/>
    </div>
