...
<html>
  <head>
    ...
    <link href="files/申请密保/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/申请密保/data.js"></script>
  ...
  <body>
    ...
    <div id="u22" class="ax_图片">
      <img id="u22_img" class="img " src="images/会员中心默认页/u11.jpg"/>
      <!-- Unnamed () -->
    ...
    <div id="u28" class="ax_动态面板" data-label="主导航">
      <div id="u28_state0" class="panel_state" data-label="State1">
        ...
        <div id="u41" class="ax_水平线">
          ...
          <img id="u41_line" class="img " src="images/首页/u224_line.png" alt="u41_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u42" class="ax_形状">
          <img id="u42_img" class="img " src="images/首页/u225.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u44" class="ax_图片">
      <img id="u44_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u48" class="ax_形状">
      <img id="u48_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u50" class="ax_文本">
      ...
      <div id="u51" class="text">
        <p><span>密码保护问题</span><span>：</span></p>
      </div>
    </div>
    ...
    <div id="u52" class="ax_文本">
      ...
      <div id="u53" class="text">
        <p><span>密码保护问题</span><span>答案</span><span>：</span></p>
      </div>
    </div>
    ...
    <div id="u67" class="ax_下拉列表框">
      <select id="u67_input">
        ...
        <option value="我最喜爱的动物是？">我最喜爱的动物是？</option>
      </select>
    </div>
    ...
    <div id="u68" class="ax_动态面板" data-label="alert">
      <div id="u68_state0" class="panel_state" data-label="State1">
        ...
        <!-- border (形状) -->
        <div id="u69" class="ax_形状" data-label="border">
          <img id="u69_img" class="img " src="images/修改个人资料/border_u253.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u71" class="ax_图片">
          <img id="u71_img" class="img " src="images/修改个人资料/u255.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u73" class="ax_图片">
          <img id="u73_img" class="img " src="images/修改个人资料/u257.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u79" class="ax_形状">
          <img id="u79_img" class="img " src="images/修改个人资料/u263.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u92" class="ax_水平线">
      ...
      <img id="u92_line" class="img " src="images/首页/u228_line.png" alt="u92_line"/>
    </div>
