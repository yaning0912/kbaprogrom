...
<html>
  ...
  <body>
    ...
    <div id="u55" class="ax_文本框_单行_">
      <input id="u55_input" type="password" value=""/>
    </div>

    <!-- Unnamed (文本框(单行)) -->
    <div id="u56" class="ax_文本框_单行_">
      <input id="u56_input" type="password" value=""/>
    </div>
    ...
    <div id="u72" class="ax_动态面板" data-label="alert">
      <div id="u72_state0" class="panel_state" data-label="State1">
        ...
        <div id="u73" class="ax_形状" data-label="border">
          <img id="u73_img" class="img " src="images/修改个人资料/border_u253.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u75" class="ax_图片">
          <img id="u75_img" class="img " src="images/修改个人资料/u255.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u77" class="ax_图片">
          <img id="u77_img" class="img " src="images/修改个人资料/u257.jpg"/>
          <!-- Unnamed () -->
        ...
        <div id="u83" class="ax_形状">
          <img id="u83_img" class="img " src="images/修改个人资料/u263.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u96" class="ax_水平线">
      ...
      <img id="u96_line" class="img " src="images/首页/u228_line.png" alt="u96_line"/>
    </div>
