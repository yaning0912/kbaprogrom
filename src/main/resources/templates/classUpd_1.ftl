...
<html>
  <head>
    ...
    <link href="files/修改班级_1/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/修改班级_1/data.js"></script>
  ...
  <body>
    ...
    <div id="u0" class="ax_水平线">
      ...
      <img id="u0_line" class="img " src="images/首页/u228_line.png" alt="u0_line"/>
    </div>
    ...
    <div id="u13" class="ax_水平线">
      ...
      <img id="u13_line" class="img " src="images/会员中心默认页/u27_line.png" alt="u13_line"/>
    </div>
    ...
    <div id="u16" class="ax_文本框_单行_">
      <input id="u16_input" type="text" value="创业实训班"/>
    </div>
    ...
    <!-- createSchool (动态面板) -->
    <div id="u23" class="ax_动态面板" data-label="createSchool">
      <div id="u23_state0" class="panel_state" data-label="1">
        ...
        <!-- 马上去创建 (形状) -->
        <div id="u26" class="ax_文本" data-label="马上去创建">
      ...
      <div id="u23_state1" class="panel_state" data-label="2">
        ...
        <!-- 添加 (形状) -->
        <div id="u39" class="ax_文本" data-label="添加">
        ...
        <!-- 添加成功 (形状) -->
        <div id="u44" class="ax_文本" data-label="添加成功">
    ...
    <div id="u46" class="ax_形状">
      <img id="u46_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u68" class="ax_图片">
      <img id="u68_img" class="img " src="images/管理班级/u42.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u74" class="ax_图片">
      <img id="u74_img" class="img " src="images/修改密码_1/u0.jpg"/>
      <!-- Unnamed () -->
    ...
    <!-- 导航 (动态面板) -->
    <div id="u84" class="ax_动态面板" data-label="导航">
      <div id="u84_state0" class="panel_state" data-label="State1">
        ...
        <div id="u93" class="ax_水平线">
          ...
          <img id="u93_line" class="img " src="images/修改密码_1/u21_line.png" alt="u93_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u94" class="ax_形状">
          <img id="u94_img" class="img " src="images/新闻管理/u12.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u98" class="ax_形状">
      <img id="u98_img" class="img " src="images/修改个人资料/u102.png"/>
      <!-- Unnamed () -->
