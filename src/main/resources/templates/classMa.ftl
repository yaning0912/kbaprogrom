...
<html>
  <head>
    ...
    <link href="files/班级管理/styles.css" type="text/css" rel="stylesheet"/>
    ...
    <script src="files/班级管理/data.js"></script>
  ...
  <body>
    ...
    <!-- Unnamed (树) -->
    <div id="u0" class="ax_树节点 treeroot">
      <div id="u0_children" class="u0_children">

        <!-- Unnamed (树节点) -->
        <div id="u1" class="ax_树节点 treenode">

          <!-- Unnamed (图片) -->
          <div id="u2" class="ax_图片">
            <img id="u2_img" class="img " src="images/管理班级/u46_selected.png"/>
            <!-- Unnamed () -->
            <div id="u3" class="text"></div>
          </div>
          <!-- Unnamed (形状) -->
          <div id="u4" class="" selectiongroup="u0_tree_group">
          ...
          <div id="u1_children" class="u1_children">
            ...
            <!-- Unnamed (树节点) -->
            <div id="u6" class="ax_树节点 treenode">

              <!-- Unnamed (图片) -->
              <div id="u7" class="ax_图片">
                <img id="u7_img" class="img " src="images/管理班级/u46_selected.png"/>
                <!-- Unnamed () -->
                <div id="u8" class="text"></div>
              </div>
              <!-- Unnamed (形状) -->
              <div id="u9" class="" selectiongroup="u0_tree_group">
              ...
              <div id="u6_children" class="u6_children">
                ...
                <!-- Unnamed (树节点) -->
                <div id="u11" class="ax_树节点 treenode">
                  <!-- Unnamed (形状) -->
                  <div id="u12" class="" selectiongroup="u0_tree_group">
                    <img id="u12_img" class="img " src="images/管理班级/u56.png"/>
                    <!-- Unnamed () -->
                    <div id="u13" class="text">
                      <p><span>创业实训一班</span></p>
                    </div>
                  </div>
                </div>

                <!-- Unnamed (树节点) -->
                <div id="u14" class="ax_树节点 treenode">
                  <!-- Unnamed (形状) -->
                  <div id="u15" class="" selectiongroup="u0_tree_group">
    ...
    <div id="u17" class="ax_垂直线">
      ...
      <img id="u17_line" class="img " src="images/管理班级/u61_line.png" alt="u17_line"/>
    </div>
    ...
    <div id="u18" class="ax_文本">
      ...
      <div id="u19" class="text">
        <p><span>注：</span></p><p><span>1.</span><span>点击</span><span>省份出现该省份的大学，点击大学出现该大学下的班级。点击班级右侧出现该班级的基本信息。</span><span>2.</span><span>右键省份和学校，在出现的菜单中选择相应的操作。</span></p><p><span>3.右键删除省份或学校，如果该节点下有班级记录则提示不能删除</span><span>。</span></p>
      </div>
    </div>

    <!-- Unnamed (表格) -->
    <div id="u20" class="ax_表格">

      <!-- Unnamed (表格单元) -->
      <div id="u21" class="ax_表格单元">
        <img id="u21_img" class="img " src="images/班级管理/u21.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u23" class="ax_表格单元">
        <img id="u23_img" class="img " src="images/班级管理/u23.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u25" class="ax_表格单元">
        <img id="u25_img" class="img " src="images/班级管理/u25.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u27" class="ax_表格单元">
        <img id="u27_img" class="img " src="images/班级管理/u23.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u29" class="ax_表格单元">
        <img id="u29_img" class="img " src="images/班级管理/u25.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u31" class="ax_表格单元">
        <img id="u31_img" class="img " src="images/班级管理/u31.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u33" class="ax_表格单元">
        <img id="u33_img" class="img " src="images/班级管理/u33.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u35" class="ax_表格单元">
        <img id="u35_img" class="img " src="images/班级管理/u35.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u37" class="ax_表格单元">
        <img id="u37_img" class="img " src="images/班级管理/u37.png"/>
        <!-- Unnamed () -->
        <div id="u38" class="text">
          <p><span>李</span><span>素</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u39" class="ax_表格单元">
        <img id="u39_img" class="img " src="images/班级管理/u35.png"/>
        <!-- Unnamed () -->
        <div id="u40" class="text">
          <p><span>学</span><span>生班</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u41" class="ax_表格单元">
        <img id="u41_img" class="img " src="images/班级管理/u37.png"/>
        <!-- Unnamed () -->
        <div id="u42" class="text">
          <p><span>开</span><span>班中</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u43" class="ax_表格单元">
        <img id="u43_img" class="img " src="images/班级管理/u43.png"/>
        <!-- Unnamed () -->
        <div id="u44" class="text">
          <p><span>2013-12-15</span></p>
        </div>
      </div>
    </div>
    ...
    <div id="u45" class="ax_文本">
      ...
      <div id="u46" class="text">
        <p><span>班级基本信息：</span></p>
      </div>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u47" class="ax_图片">
      <img id="u47_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u49" class="ax_文本">
      ...
      <div id="u50" class="text">
        <p><span>修改</span><span>班级</span></p>
      </div>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u51" class="ax_图片">
      <img id="u51_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u55" class="ax_文本">
      ...
      <div id="u56" class="text">
        <p><span>该</span><span>班级学生信息列表：</span></p>
      </div>
    </div>
    ...
    <div id="u57" class="ax_表格">
      ...
      <div id="u58" class="ax_表格单元">
        <img id="u58_img" class="img " src="images/班级管理/u58.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u60" class="ax_表格单元">
        <img id="u60_img" class="img " src="images/班级管理/u60.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u62" class="ax_表格单元">
        <img id="u62_img" class="img " src="images/班级管理/u62.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u64" class="ax_表格单元">
        <img id="u64_img" class="img " src="images/班级管理/u64.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u66" class="ax_表格单元">
        <img id="u66_img" class="img " src="images/班级管理/u66.png"/>
        <!-- Unnamed () -->
        <div id="u67" class="text">
          <p><span>年</span><span>龄</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u68" class="ax_表格单元">
        <img id="u68_img" class="img " src="images/班级管理/u68.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u70" class="ax_表格单元">
        <img id="u70_img" class="img " src="images/班级管理/u70.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u72" class="ax_表格单元">
        <img id="u72_img" class="img " src="images/班级管理/u72.png"/>
        <!-- Unnamed () -->
        <div id="u73" class="text">
          <p><span>年</span><span>级</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u74" class="ax_表格单元">
        <img id="u74_img" class="img " src="images/班级管理/u74.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u76" class="ax_表格单元">
        <img id="u76_img" class="img " src="images/班级管理/u76.png"/>
        <!-- Unnamed () -->
        <div id="u77" class="text">
          <p><span>CYSX01</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u78" class="ax_表格单元">
        <img id="u78_img" class="img " src="images/班级管理/u78.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u80" class="ax_表格单元">
        <img id="u80_img" class="img " src="images/班级管理/u80.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u82" class="ax_表格单元">
        <img id="u82_img" class="img " src="images/班级管理/u82.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u84" class="ax_表格单元">
        <img id="u84_img" class="img " src="images/班级管理/u84.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u86" class="ax_表格单元">
        <img id="u86_img" class="img " src="images/班级管理/u86.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u88" class="ax_表格单元">
        <img id="u88_img" class="img " src="images/班级管理/u88.png"/>
        <!-- Unnamed () -->
        <div id="u89" class="text">
          <p><span>大</span><span>二</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u90" class="ax_表格单元">
        <img id="u90_img" class="img " src="images/班级管理/u90.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u92" class="ax_表格单元">
        <img id="u92_img" class="img " src="images/班级管理/u92.png"/>
        <!-- Unnamed () -->
        <div id="u93" class="text">
          <p><span>CYSX0</span><span>2</span></p>
        </div>
      </div>

      <!-- Unnamed (表格单元) -->
      <div id="u94" class="ax_表格单元">
        <img id="u94_img" class="img " src="images/班级管理/u94.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u96" class="ax_表格单元">
        <img id="u96_img" class="img " src="images/班级管理/u96.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u98" class="ax_表格单元">
        <img id="u98_img" class="img " src="images/班级管理/u98.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u100" class="ax_表格单元">
        <img id="u100_img" class="img " src="images/班级管理/u100.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u102" class="ax_表格单元">
        <img id="u102_img" class="img " src="images/班级管理/u102.png"/>
        <!-- Unnamed () -->
      ...
      <div id="u104" class="ax_表格单元">
        <img id="u104_img" class="img " src="images/班级管理/u104.png"/>
        <!-- Unnamed () -->
        <div id="u105" class="text">
          <p><span>大</span><span>四</span></p>
        </div>
      </div>
    </div>
    ...
    <div id="u106" class="ax_水平线">
      ...
      <img id="u106_line" class="img " src="images/管理班级/u148_line.png" alt="u106_line"/>
    </div>

    <!-- Unnamed (复选框) -->
    <div id="u107" class="ax_复选框">
      <label for="u107_input">
        <!-- Unnamed () -->
        <div id="u108" class="text"></div>
      </label>
      <input id="u107_input" type="checkbox" value="checkbox" checked/>
    </div>

    <!-- Unnamed (复选框) -->
    <div id="u109" class="ax_复选框">
      <label for="u109_input">
        <!-- Unnamed () -->
        <div id="u110" class="text"></div>
      </label>
      <input id="u109_input" type="checkbox" value="checkbox"/>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u111" class="ax_图片">
      <img id="u111_img" class="img " src="images/管理班级/u89.png"/>
      <!-- Unnamed () -->
      <div id="u112" class="text"></div>
    </div>
    ...
    <div id="u113" class="ax_文本">
      ...
      <div id="u114" class="text">
        <p><span>删除</span><span>学生</span></p>
      </div>
    </div>

    <!-- alert-warn是否删除 (动态面板) -->
    <div id="u115" class="ax_动态面板" data-label="alert-warn是否删除">
      <div id="u115_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u116" class="ax_形状">
          <img id="u116_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u120" class="ax_水平线">
          ...
          <img id="u120_line" class="img " src="images/修改密码_1/u48_line.png" alt="u120_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u121" class="ax_形状">
          <img id="u121_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u123" class="ax_图片">
          <img id="u123_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u125" class="ax_文本">
          ...
          <div id="u126" class="text">
            <p><span>确定删除所选记录吗？</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u127" class="ax_图片">
          <img id="u127_img" class="img " src="images/新闻管理/u158.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u129" class="ax_形状">
          <img id="u129_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
    ...
    <!-- alert-删除成功 (动态面板) -->
    <div id="u131" class="ax_动态面板" data-label="alert-删除成功">
      <div id="u131_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u132" class="ax_形状">
          <img id="u132_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u136" class="ax_水平线">
          ...
          <img id="u136_line" class="img " src="images/修改密码_1/u48_line.png" alt="u136_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u137" class="ax_形状">
          <img id="u137_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u139" class="ax_图片">
          <img id="u139_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
    ...
    <!-- alert-添加成功 (动态面板) -->
    <div id="u143" class="ax_动态面板" data-label="alert-添加成功">
      <div id="u143_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u144" class="ax_形状">
          <img id="u144_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u148" class="ax_水平线">
          ...
          <img id="u148_line" class="img " src="images/修改密码_1/u48_line.png" alt="u148_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u149" class="ax_形状">
          <img id="u149_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u151" class="ax_图片">
          <img id="u151_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u155" class="ax_图片">
      <img id="u155_img" class="img " src="images/修改密码_1/u0.jpg"/>
      <!-- Unnamed () -->
    ...
    <!-- 导航 (动态面板) -->
    <div id="u165" class="ax_动态面板" data-label="导航">
      <div id="u165_state0" class="panel_state" data-label="State1">
        ...
        <div id="u174" class="ax_水平线">
          ...
          <img id="u174_line" class="img " src="images/修改密码_1/u21_line.png" alt="u174_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u175" class="ax_形状">
          <img id="u175_img" class="img " src="images/新闻管理/u12.png"/>
          <!-- Unnamed () -->
    ...
    <div id="u181" class="ax_水平线">
      ...
      <img id="u181_line" class="img " src="images/kab公告管理/u123_line.png" alt="u181_line"/>
    </div>

    <!-- Unnamed (单选框) -->
    <div id="u182" class="ax_单选框">
      <label for="u182_input">
        <!-- Unnamed () -->
        <div id="u183" class="text"></div>
      </label>
      <input id="u182_input" type="radio" value="radio" name="u182" checked/>
    </div>

    <!-- Unnamed (图片) -->
    <div id="u184" class="ax_图片">
      <img id="u184_img" class="img " src="images/修改个人资料/u46.png"/>
      <!-- Unnamed () -->
    ...
    <div id="u188" class="ax_文本">
      ...
      <div id="u189" class="text">
        <p><span>[+添加</span><span>省份</span><span>]</span></p>
      </div>
    </div>
    ...
    <!-- Unnamed (形状) -->
    <div id="u208" class="ax_形状">
      <img id="u208_img" class="img " src="images/kab公告/u99.png"/>
      <!-- Unnamed () -->
      <div id="u209" class="text"></div>
    </div>
    ...
    <!-- 城市右键菜单 (动态面板) -->
    <div id="u212" class="ax_动态面板" data-label="城市右键菜单">
      <div id="u212_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u213" class="ax_形状">
          <img id="u213_img" class="img " src="images/班级管理/u213.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u215" class="ax_图片">
          <img id="u215_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u219" class="ax_水平线">
          ...
          <img id="u219_line" class="img " src="images/管理班级/u346_line.png" alt="u219_line"/>
        </div>
        ...
        <div id="u224" class="ax_文本">
          ...
          <div id="u225" class="text">
            <p><span>删除</span><span>省份</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u226" class="ax_图片">
          <img id="u226_img" class="img " src="images/班级管理/u226.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u228" class="ax_图片">
          <img id="u228_img" class="img " src="images/管理班级/u351.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u230" class="ax_图片">
          <img id="u230_img" class="img " src="images/管理班级/u89.png"/>
          <!-- Unnamed () -->
    ...
    <!-- 学校右键菜单 (动态面板) -->
    <div id="u232" class="ax_动态面板" data-label="学校右键菜单">
      <div id="u232_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u233" class="ax_形状">
          <img id="u233_img" class="img " src="images/管理班级/u340.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u235" class="ax_图片">
          <img id="u235_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (水平线) -->
        <div id="u239" class="ax_水平线">
          <img id="u239_start" class="img " src="resources/images/transparent.gif" alt="u239_start"/>
          <img id="u239_end" class="img " src="resources/images/transparent.gif" alt="u239_end"/>
          <img id="u239_line" class="img " src="images/管理班级/u346_line.png" alt="u239_line"/>
        </div>
        ...
        <div id="u242" class="ax_文本">
          ...
          <div id="u243" class="text">
            <p><span>删除</span><span>学校</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u244" class="ax_图片">
          <img id="u244_img" class="img " src="images/管理班级/u351.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u246" class="ax_图片">
          <img id="u246_img" class="img " src="images/管理班级/u89.png"/>
          <!-- Unnamed () -->
    ...
    <!-- 添加省份 (动态面板) -->
    <div id="u252" class="ax_动态面板" data-label="添加省份">
      <div id="u252_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u253" class="ax_形状">
          <img id="u253_img" class="img " src="images/管理班级/u358.png"/>
          <!-- Unnamed () -->
          <div id="u254" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u255" class="ax_形状">
          <img id="u255_img" class="img " src="images/管理班级/u201.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u257" class="ax_图片">
          <img id="u257_img" class="img " src="images/管理班级/u93.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u259" class="ax_文本">
          ...
          <div id="u260" class="text">
            <p><span>添加省份</span><span>信息</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u261" class="ax_图片">
          <img id="u261_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
          <div id="u262" class="text"></div>
        </div>

        <!-- Unnamed (水平线) -->
        <div id="u263" class="ax_水平线">
          <img id="u263_start" class="img " src="resources/images/transparent.gif" alt="u263_start"/>
          <img id="u263_end" class="img " src="resources/images/transparent.gif" alt="u263_end"/>
          <img id="u263_line" class="img " src="images/管理班级/u213_line.png" alt="u263_line"/>
        </div>
        ...
        <div id="u266" class="ax_形状">
          <img id="u266_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u268" class="ax_形状">
          <img id="u268_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u273" class="ax_文本">
          ...
          <div id="u274" class="text">
            <p><span>排序</span><span>：</span></p>
          </div>
        </div>

        <!-- Unnamed (文本框(单行)) -->
        <div id="u275" class="ax_文本框_单行_">
          <input id="u275_input" type="text" value="0"/>
        </div>
      </div>
    </div>

    <!-- 修改省份 (动态面板) -->
    <div id="u276" class="ax_动态面板" data-label="修改省份">
      <div id="u276_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u277" class="ax_形状">
          <img id="u277_img" class="img " src="images/管理班级/u358.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u279" class="ax_形状">
          <img id="u279_img" class="img " src="images/管理班级/u201.png"/>
          <!-- Unnamed () -->
          <div id="u280" class="text"></div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u281" class="ax_图片">
          <img id="u281_img" class="img " src="images/管理班级/u93.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u283" class="ax_文本">
          ...
          <div id="u284" class="text">
            <p><span>修改</span><span>省份</span><span>信息</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u285" class="ax_图片">
          <img id="u285_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
          <div id="u286" class="text"></div>
        </div>

        <!-- Unnamed (水平线) -->
        <div id="u287" class="ax_水平线">
          <img id="u287_start" class="img " src="resources/images/transparent.gif" alt="u287_start"/>
          <img id="u287_end" class="img " src="resources/images/transparent.gif" alt="u287_end"/>
          <img id="u287_line" class="img " src="images/管理班级/u213_line.png" alt="u287_line"/>
        </div>
        ...
        <div id="u290" class="ax_形状">
          <img id="u290_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u292" class="ax_形状">
          <img id="u292_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u296" class="ax_文本框_单行_">
          <input id="u296_input" type="text" value="北京"/>
        </div>
        ...
        <!-- Unnamed (文本框(单行)) -->
        <div id="u299" class="ax_文本框_单行_">
          <input id="u299_input" type="text" value="0"/>
        </div>
      </div>
    </div>

    <!-- 添加学校 (动态面板) -->
    <div id="u300" class="ax_动态面板" data-label="添加学校">
      <div id="u300_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u301" class="ax_形状">
          <img id="u301_img" class="img " src="images/管理班级/u358.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u303" class="ax_形状">
          <img id="u303_img" class="img " src="images/管理班级/u201.png"/>
          <!-- Unnamed () -->
          <div id="u304" class="text"></div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u305" class="ax_图片">
          <img id="u305_img" class="img " src="images/管理班级/u93.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u307" class="ax_文本">
          ...
          <div id="u308" class="text">
            <p><span>添加</span><span>学校信息</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u309" class="ax_图片">
          <img id="u309_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
          <div id="u310" class="text"></div>
        </div>

        <!-- Unnamed (水平线) -->
        <div id="u311" class="ax_水平线">
          <img id="u311_start" class="img " src="resources/images/transparent.gif" alt="u311_start"/>
          <img id="u311_end" class="img " src="resources/images/transparent.gif" alt="u311_end"/>
          <img id="u311_line" class="img " src="images/管理班级/u213_line.png" alt="u311_line"/>
        </div>
        ...
        <div id="u314" class="ax_形状">
          <img id="u314_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u316" class="ax_形状">
          <img id="u316_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (文本框(单行)) -->
        <div id="u323" class="ax_文本框_单行_">
          <input id="u323_input" type="text" value="0"/>
        </div>
    ...
    <!-- 修改学校 (动态面板) -->
    <div id="u328" class="ax_动态面板" data-label="修改学校">
      <div id="u328_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u329" class="ax_形状">
          <img id="u329_img" class="img " src="images/管理班级/u358.png"/>
          <!-- Unnamed () -->
          <div id="u330" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u331" class="ax_形状">
          <img id="u331_img" class="img " src="images/管理班级/u201.png"/>
          <!-- Unnamed () -->
          <div id="u332" class="text"></div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u333" class="ax_图片">
          <img id="u333_img" class="img " src="images/管理班级/u93.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u335" class="ax_文本">
          ...
          <div id="u336" class="text">
            <p><span>修改</span><span>学校信息</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u337" class="ax_图片">
          <img id="u337_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
          <div id="u338" class="text"></div>
        </div>

        <!-- Unnamed (水平线) -->
        <div id="u339" class="ax_水平线">
          <img id="u339_start" class="img " src="resources/images/transparent.gif" alt="u339_start"/>
          <img id="u339_end" class="img " src="resources/images/transparent.gif" alt="u339_end"/>
          <img id="u339_line" class="img " src="images/管理班级/u213_line.png" alt="u339_line"/>
        </div>
        ...
        <!-- Unnamed (形状) -->
        <div id="u342" class="ax_形状">
          <img id="u342_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (形状) -->
        <div id="u344" class="ax_形状">
          <img id="u344_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (文本框(单行)) -->
        <div id="u348" class="ax_文本框_单行_">
          <input id="u348_input" type="text" value="北京航天航空大学"/>
        </div>
        ...
        <div id="u351" class="ax_文本框_单行_">
          <input id="u351_input" type="text" value="1"/>
        </div>
    ...
    <!-- alert-warn是否删除班级 (动态面板) -->
    <div id="u356" class="ax_动态面板" data-label="alert-warn是否删除班级">
      <div id="u356_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u357" class="ax_形状">
          <img id="u357_img" class="img " src="images/修改密码_1/u44.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (水平线) -->
        <div id="u361" class="ax_水平线">
          <img id="u361_start" class="img " src="resources/images/transparent.gif" alt="u361_start"/>
          <img id="u361_end" class="img " src="resources/images/transparent.gif" alt="u361_end"/>
          <img id="u361_line" class="img " src="images/修改密码_1/u48_line.png" alt="u361_line"/>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u362" class="ax_形状">
          <img id="u362_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u364" class="ax_图片">
          <img id="u364_img" class="img " src="images/修改密码_1/u51.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u366" class="ax_文本">
          ...
          <div id="u367" class="text">
            <p><span>确定删除该班级吗？</span></p>
          </div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u368" class="ax_形状">
          <img id="u368_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <!-- Unnamed (图片) -->
        <div id="u370" class="ax_图片">
          <img id="u370_img" class="img " src="images/新闻管理/u158.png"/>
          <!-- Unnamed () -->
    ...
    <!-- 修改学生信息 (动态面板) -->
    <div id="u372" class="ax_动态面板" data-label="修改学生信息">
      <div id="u372_state0" class="panel_state" data-label="State1">

        <!-- Unnamed (形状) -->
        <div id="u373" class="ax_形状">
          <img id="u373_img" class="img " src="images/班级管理/u373.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u375" class="ax_形状">
          <img id="u375_img" class="img " src="images/班级管理/u375.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u377" class="ax_形状">
          <img id="u377_img" class="img " src="images/管理班级/u201.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u379" class="ax_图片">
          <img id="u379_img" class="img " src="images/管理班级/u93.png"/>
          <!-- Unnamed () -->
          <div id="u380" class="text"></div>
        </div>

        <!-- Unnamed (形状) -->
        <div id="u381" class="ax_文本">
          <img id="u381_img" class="img " src="resources/images/transparent.gif"/>
          <!-- Unnamed () -->
          <div id="u382" class="text">
            <p><span>修改</span><span>学生</span><span>信息</span></p>
          </div>
        </div>

        <!-- Unnamed (图片) -->
        <div id="u383" class="ax_图片">
          <img id="u383_img" class="img " src="images/管理班级/u211.png"/>
          <!-- Unnamed () -->
          <div id="u384" class="text"></div>
        </div>

        <!-- Unnamed (水平线) -->
        <div id="u385" class="ax_水平线">
          <img id="u385_start" class="img " src="resources/images/transparent.gif" alt="u385_start"/>
          <img id="u385_end" class="img " src="resources/images/transparent.gif" alt="u385_end"/>
          <img id="u385_line" class="img " src="images/管理班级/u213_line.png" alt="u385_line"/>
        </div>
        ...
        <div id="u400" class="ax_文本框_单行_">
          <input id="u400_input" type="text" value="CYXP01"/>
        </div>
        ...
        <!-- Unnamed (文本框(单行)) -->
        <div id="u403" class="ax_文本框_单行_">
          <input id="u403_input" type="text" value="张思德"/>
        </div>

        <!-- sex1 (单选框) -->
        <div id="u404" class="ax_单选框">
          ...
          <input id="u404_input" type="radio" value="radio" data-label="sex1" name="u404" checked/>
        </div>

        <!-- sex2 (单选框) -->
        <div id="u406" class="ax_单选框">
          ...
          <input id="u406_input" type="radio" value="radio" data-label="sex2" name="u406"/>
        </div>

        <!-- Unnamed (文本框(单行)) -->
        <div id="u408" class="ax_文本框_单行_">
          <input id="u408_input" type="text" value="25"/>
        </div>
        ...
        <div id="u409" class="ax_文本">
          ...
          <div id="u410" class="text">
            <p><span>学校</span><span>：</span></p>
          </div>
        </div>

        <!-- Unnamed (文本框(单行)) -->
        <div id="u411" class="ax_文本框_单行_">
          <input id="u411_input" type="text" value="北京航空航天大学"/>
        </div>

        <!-- Unnamed (文本框(单行)) -->
        <div id="u412" class="ax_文本框_单行_">
          <input id="u412_input" type="text" value="软件工程"/>
        </div>

        <!-- Unnamed (下拉列表框) -->
        <div id="u413" class="ax_下拉列表框">
          <select id="u413_input">
            <option value="--请选择--">--请选择--</option>
            <option value="大一">大一</option>
            <option selected value="大二">大二</option>
        ...
        <div id="u414" class="ax_形状">
          <img id="u414_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
        ...
        <div id="u416" class="ax_形状">
          <img id="u416_img" class="img " src="images/修改密码_1/u49.png"/>
          <!-- Unnamed () -->
